...
function list_categories(){
	...
	foreach ($categories as $item) {
		echo '<a href="'. get_permalink('category', $item->slug) .'"><li>'. _t(esc_string($item->name)) .'</li></a>';
	}
	echo '</ul>';
}
		...
		<a href="<?php echo get_permalink('game', $game->slug) ?>">
			<div class="wgt-list-game">
				...
				<div class="col-8 p-0 wgt-list-content">
					...
					<div class="wgt-list-category"><?php echo esc_string($category); ?></div>
				</div>
			</div>
		</a>
	</div>
...
register_sidebar(array(
	'name' => 'Homepage Top',
	'id' => 'homepage-top',
	'description' => 'Top content on homepage. Can be used to show site description or explaining about your site.',
));
