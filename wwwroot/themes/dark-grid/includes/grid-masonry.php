...
<div class="grid-item <?php echo esc_string($span) ?> item-grid">
	...
	<div class="list-game">
		<div class="list-thumbnail"><img src="<?php echo get_template_path(); ?>/images/thumb-placeholder1.png" data-src="<?php echo $thumb ?>" class="small-thumb lazyload" alt="<?php echo esc_string($_game_title) ?>"></div>
